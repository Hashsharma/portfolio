...
const greeting = {
  ...
  subTitle: emoji(
    "As a software developer, I bring creativity and innovation to every project I work on. I am constantly learning and growing, staying up-to-date with the latest technologies and techniques to bring the best solutions to the table."
  ),
  resumeLink:
  ...
  experience: [
    {
      ...
      desc: "Ful.io is making data more accessible to the world. We offer technographic insights and lead generation tools to sales and marketing teams globally. We track over a thousand web technologies across millions of websites",
      descBullets: [
        "Ful.io tracks a spectrum of technologies—from widgets, analytics, and CMS to advertisers, CDN, web standards, and servers, offering comprehensive coverage across various tech categories.",
        "Embracing the motto \"Make mistakes fast,\" Ful.io prioritizes agile experimentation and learning for swift progress and innovation."
      ]
    },
    {
      ...
      desc: "Ubq is a pioneer in delivering Cloud based solutions in the Healthcare and Retail/Distribution verticals in India. Its services have been successfully used for over 5 years in India, starting from January 2008. ",
      descBullets: [
        "Ubq solutions come with a built-in Business Intelligence tool (or Management Dashboard), making it easier for our customers to get a better handle on their business data. Ubq is committed to keeping the cost of IT solutions to a minimum.",
      ]
    }
    // {
